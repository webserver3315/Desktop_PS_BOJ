...
string* Game(string board[], int depth, int mode) {/*0~3: 상하좌우*/
	...
	string* RealInitialBoard = InitialBoard;
	if (0 == mode) {
		GoUp(InitialBoard, depth);
		InitialBoard = RealInitialBoard;
		return RealInitialBoard;
	}
	else if (1 == mode) {
		GoDown(board, depth);
		return InitialBoard;
